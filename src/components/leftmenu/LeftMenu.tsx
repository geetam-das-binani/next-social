...
const LeftMenu = ({ type }: { type: "home" | "profile" }) => {
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col p-2  gap-2 text-gray-500
       text-sm bg-white shadow-md rounded-lg">
        <Link
          href={"/"}
          className="flex items-center gap-4 p-4 hover:bg-slate-100 rounded-lg"
        >
          <Image src="/posts.png" alt="homePage" width={16} height={16} />
          <span>My Posts</span>
        </Link>
